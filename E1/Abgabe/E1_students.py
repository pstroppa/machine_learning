...
students_df = pd.read_csv(filename, sep =",", lineterminator="\n", encoding="utf-8",error_bad_lines=False)
students_kaggle_test = pd.read_csv('Student_test.csv', sep =",", lineterminator="\n", encoding="utf-8",error_bad_lines=False)
...
for i in range(1): #mache 5 runs, jeweils unterschiedliche test und trainingsdaten
...
#preprocessing
    ...
    X4=X_train.copy()
    X4=X4.drop(columns=['school','famsize','Pstatus','Fjob','reason','guardian','schoolsup','famsup','activities','famrel','Dalc','Walc','health','absences\r'])
    ...
    X4_test=X_test.copy()
    X4_test=X4_test.drop(columns=['school','famsize','Pstatus','Fjob','reason','guardian','schoolsup','famsup','activities','famrel','Dalc','Walc','health','absences\r'])
