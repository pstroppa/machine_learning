...
#
#für energy hat sich als bestes Preprocessing hat sich Nr 4 herausgestellt: scalar und droppen von 'X6'
#mit kNN für k=4, algorithm ='ball_tree' und weight = 'distance', schlechtestes Preprocessing ist hierfür 1 und 3, also keine
#Änderung und minmax scaling. Allerdings ist tree sehr knapp dahinter. gefühlt hat tree größere
#Schwankungsbreiten bei den fehlern. 
#
...
filename="energy.csv"
methode = "tree"
energy_df = pd.read_csv(filename, sep =";", lineterminator="\n", encoding="utf-8", error_bad_lines=False)
...
y = energy_df["Y1"]
X = energy_df.drop(columns=["Y2\r","Y1"])
...
#applying methodes:
    ...
    if type(methode) is str:
        if methode is "lasso":
            ...
            methode = tree.DecisionTreeRegressor(min_samples_leaf=2,max_depth=8)   
...
#  evaluation for all 5 measures (see pptx numeric_values: Slide 36):
    ...
    #methode = neighbors.KNeighborsRegressor(3, weights='distance',algorithm ='ball_tree')
